...
public class AlfheimrPortalShape {
    private static final int MIN_WIDTH = 1;
    public static final int MAX_WIDTH = 21;
    private static final int MIN_HEIGHT = 2;
    public static final int MAX_HEIGHT = 21;
    private static final BlockBehaviour.StatePredicate FRAME = (state, getter, pos) -> state.is(YggdrasilRealmsBeyondBlocks.ALFHEIMR_PORTAL_FRAME_BLOCK.get());
    ...
    private int getDistanceUntilTop(BlockPos.MutableBlockPos pos) {
        for (int i = 0; i < MAX_HEIGHT; ++i) {
            ...
            for (int j = 0; j < this.width; ++j) {
                ...
                if (blockstate.is(YggdrasilRealmsBeyondBlocks.ALFHEIMR_PORTAL_BLOCK.get())) {
    ...
    private static boolean isEmpty(BlockState state) {
        return state.isAir() || state.is(YggdrasilRealmsBeyondBlocks.ALFHEIMR_PORTAL_BLOCK.get());
    }
    ...
    public void createPortalBlocks() {
        BlockState blockstate = YggdrasilRealmsBeyondBlocks.ALFHEIMR_PORTAL_BLOCK.get().defaultBlockState().setValue(AlfheimrPortalBlock.AXIS, this.axis);
