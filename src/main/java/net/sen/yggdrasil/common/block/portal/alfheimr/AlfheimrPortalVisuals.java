...
public class AlfheimrPortalVisuals {
    ...
    public static void handlePortalVisuals(Player player) {
        if (player.level().isClientSide()) {
            ...
            if (player.portalProcess != null && player.portalProcess.isSamePortal((Portal) YggdrasilRealmsBeyondBlocks.ALFHEIMR_PORTAL_BLOCK.get()) && player.portalProcess.isInsidePortalThisTick()) {
